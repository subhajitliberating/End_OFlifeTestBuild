...
const DeathNoticesList = ({ token }) => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL}directory/death-notices/user/by/get`,
        {
          params: {
  ...
  const confirmDelete = async () => {
    try {
      ...
      await axios.delete(
        `${import.meta.env.VITE_API_URL}directory/death-notices/deleted`,
        {
  ...
  return (
    <div className="container py-4">
      <h1 className="mb-4 cus-h1">My death Notices</h1>
...
export default DeathNoticesList;
;
